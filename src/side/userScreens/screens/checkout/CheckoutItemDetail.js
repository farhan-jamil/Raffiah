...
import { bodyLarge, bodySmall, subtitleLarge, titleSmall } from '../../../../utils/fonts'
import PrimaryButton from '../../../../components/buttons/PrimaryButton'
import Swipeer from '../../../../components/Swipeer'
export default function CheckoutItemDetail({ navigation }) {
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <>
                            ...
                            <Divider style={{ height: 1, backgroundColor: colors.neutral400 }} />
                            <View style={{ marginTop: hp(2) }} />
                            <View style={{ paddingHorizontal: wp(4) }}>
                                ...
                                >
                                    ...
                                    >
                                        <Ionicons name='person' size={20} color={colors.primary200} />
                                        <View style={{ marginLeft: wp(2) }} />
                                        <Text style={styles.descriptionText}>John</Text>

                                    </View>
                                    <View
                                        style={styles.iconTextWrapper}
                                    >
                                        <Ionicons name='location-sharp' size={20} color={colors.primary200} />
                                        <View style={{ marginLeft: wp(2) }} />
                                        <Text style={styles.descriptionText}>New York</Text>

                                    </View>
                                    <View
                                        style={styles.iconTextWrapper}
                                    >
                                        <Ionicons name='phone-portrait-sharp' size={20} color={colors.primary200} />
                                        <View style={{ marginLeft: wp(2) }} />
                                        <Text style={styles.descriptionText}>0123 456 789</Text>
