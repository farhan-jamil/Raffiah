...
import DLabelInput from '../../../../components/textInputs/disabledInputs/DLabelInput'
export default function BidingDescription({ navigation }) {
    const [checkBoxValue, setCheckBoxValue] = useState(false)
    const [inputValue, setInputValue] = useState('')
    const [currentBidAmount, setCurrentBidAmount] = useState('$12.80')
