...
import { subtitleSmall, bodySmall, subtitleLarge, titleSmall } from '../../../../utils/fonts'
import ItemImage from '../../../../assets/png/bitmap-1.png'
import InputMultiLine from '../../../../components/textInputs/InputMultiLine'

import TotalAndButtonsCard from '../../../../components/cards/orderListCard/TotalAndButtonsCard'
...
export default function BidingProductDescription({ navigation }) {
    ...
    return (
        <View style={GlobalStyle.rootContainer}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <>
                            ...
                            <View style={{
                                flex: 2, paddingHorizontal: wp(4), paddingVertical: hp(2)
                            }}>
                                <View>
                                    <Text style={[styles.heading, { textAlign: 'center' }]}>
                                        MEN'S DENIM JACKETS AND OUTWEAR
                                    </Text>
                                </View>
                                <Divider
                                    style={{ backgroundColor: colors.neutral400, height: 1 }}
                                />
                                <View style={{ marginTop: hp(2) }}>
                                    <Text style={[styles.leftText, { color: colors.neutral900 }]}>Details</Text>
                                </View>
                                <View>
                                    <Text style={[styles.rightText, { color: colors.neutral900 }]}>
                                        Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.
                                        Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem</Text>
                                </View>
                                <View>
                                    <View style={{ marginTop: hp(2) }}>
                                ...
                                <View>
                                    <View style={{ marginTop: hp(2) }}>
                                        <Text style={styles.heading}>Bidings</Text>
                                    </View>
                                    <View style={styles.textWrapper}>
                                        <Text style={styles.leftText}>
                                            Bids
            ...
            <View style={{
                ...
                <SecondaryButton
                    title={'Place A Bid'}
                    onPress={() => { navigation.navigate('BidingDescription') }}
                />
                <View style={{ marginTop: hp(2) }} />
                <PrimaryButton
                    title={'Add to Cart'}
...
const styles = StyleSheet.create({
    ...
    rightText: {
        color: colors.neutral700, fontFamily: 'poppins.regular',
        fontSize: 14
    },
    heading: {
        color: colors.neutral900,
